...
variables = ['mz','mz_zoom','leptonic_recoil_m','leptonic_recoil_m_zoom','missingET_x','missingET_y','missingET_z','missingET_e','MCAngleBW','RCAngleBW','muon_eta','resoAngleBW','acoplanarity','missingCosTheta','RecoMissingEnergy']#'eta_MCdeltaR','eta_RCdeltaR'],"FS_eta","FS_theta","FS_phi"]#'muons','selected_muons','selected_muons_pt'] #add variables to include muons?

###Dictionary with the analysis name as a key, and the list of selections to be plotted for this analysis. The name of the selections should be the same than in the final selection
selections = {}
selections['HA3']   = ["sel0"]
selections['HA3_2'] = ["sel0"]
